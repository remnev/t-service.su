        ...
        urls = [
            {
                url: {
                    ...
                    lastmod: dateFormat(data.company.lastEditDate, 'isoDateTime') + '+03:00',
                    priority: '0.1'
                }
            },
            {
            ...
            if (!~usedCategories.indexOf(categorySlug)) {
                ...
                urls.push({
                    url: {
                        ...
                        lastmod: dateFormat(service.lastEditDate, 'isoDateTime') + '+03:00',
                        priority: '0.5'
                    }
                });
            }
        ...
        data.articles.forEach(function(article) {
            urls.push({
                url: {
                    ...
                    lastmod: dateFormat(article.lastEditDate, 'isoDateTime') + '+03:00',
                    priority: '0.6'
                }
            });
        });
